...
export function StoreInboxBoard() {
    ...
    <div>
      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-muted">
            {isEmployee
              ? `${store?.name || "Your store"} · In stock, Out, or Can order`
      ...
      {canManage ? (
        ...
        <GlassNotice className="mt-6">
          Answer the asks below. Owners handle demand and settings.
        </GlassNotice>
      )}
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {item.category ? (
                    <p className="mt-1 text-xs text-ink-subtle">{item.category}</p>
                  ) : null}
                  {isAgeRestrictedFind({
