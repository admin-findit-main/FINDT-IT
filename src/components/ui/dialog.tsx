 ...
 */
const overlayClass =
  "fixed inset-0 z-[70] bg-black/40 data-[state=open]:animate-in data-[state=open]:fade-in-0";
  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "glass-strong fixed left-1/2 top-1/2 z-[70] w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-glass-2xl p-6 focus:outline-none",
          className
        )}
        {...props}
      >
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className={cn(
            "glass-strong fixed inset-x-0 bottom-0 z-[70] max-h-[92vh] overflow-y-auto rounded-t-glass-2xl px-6 pb-6 pt-3 focus:outline-none",
