...
export const adminDashItems: DashItem[] = [
  ...
  { href: "/admin/owners", label: "Owners", icon: "staff" },
  { href: "/admin/subscriptions", label: "Billing", icon: "plan" },
  { href: "/admin/hubs", label: "FINDIT Hubs", icon: "devices" },
  { href: "/admin/requests", label: "Finds", icon: "requests" },
  { href: "/admin/reports", label: "Reports", icon: "reports" },
  { href: "/admin/audit", label: "Audit", icon: "reports" },
...
export function dashTitle(pathname: string): { title: string; subtitle: string } {
  const map: Record<string, { title: string; subtitle: string }> = {
    ...
    "/admin/subscriptions": { title: "Billing", subtitle: "Store subscriptions" },
