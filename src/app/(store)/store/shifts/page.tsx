  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-ink-muted">
        Add people who work the counter. Each one gets a 4-digit PIN. They
        clock in on the Hub tablet before it unlocks, then clock out when they
        leave.
      </p>
            ...
            {onShift.map((row) => (
              ...
              >
                ...
                <p className="mt-0.5 text-sm text-ink-muted">
                  In since{" "}
                  {row.clocked_in_at ? formatRelativeTime(row.clocked_in_at) : "now"}
                </p>
              </li>
            ))}
          </ul>
