...
export default function PricingPage() {
  return (
    <LegalShell title="FINDIT pricing">
      ...
      <h2>Stores</h2>
      <p>
        <strong className="text-ink">FINDIT Business.</strong>{" "}
        ${BUSINESS_PRICE_MONTHLY}/month after the free trial. The subscription
        includes request handling, the two-section Hub, customer management,
        store loyalty, team access, devices, shifts, and demand insights.
      </p>
      <p>
